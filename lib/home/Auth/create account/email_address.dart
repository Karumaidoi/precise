...
class CreateUserMail extends StatefulWidget {
  ...
  const CreateUserMail({super.key, required this.userName});

  @override
  State<CreateUserMail> createState() => _CreateUserMailState();
}

class _CreateUserMailState extends State<CreateUserMail> {
  String email = '';
